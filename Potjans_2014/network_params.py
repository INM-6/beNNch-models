...
updated_dict = {
    ...
    'PSP_mean_matrix': get_mean_PSP_matrix(
        net_dict['PSP_exc_mean'], net_dict['g'], len(net_dict['populations'])
        ),
    # PSP std matrix.
    'PSP_std_matrix': get_std_PSP_matrix(
        net_dict['weight_rel_std'], len(net_dict['populations'])
        ),
    # mean delay matrix.
    'mean_delay_matrix': get_mean_delays(
        net_dict['delay_exc_mean'], net_dict['delay_inh_mean'],
        len(net_dict['populations'])
        ),
    # std delay matrix.
    'std_delay_matrix': get_std_delays(
        net_dict['delay_exc_mean'] * net_dict['delay_rel_std'],
        net_dict['delay_inh_mean'] * net_dict['delay_rel_std'],
        len(net_dict['populations'])
        ),
    }
